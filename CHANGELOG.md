...
- ce944db: Removed styles for forminator-monospace class.
- b3fd0af: Fix multi-select XSS vulnerability.
- 1ef0c16: Fix pagination steps focus style.
- cd1f116: Fix RTL styles for select and multiselect.
