...
- 53f5f6e: Removed styles for forminator-monospace class.
- 53f5f6e: Fix multi-select XSS vulnerability.
- 53f5f6e: Fix pagination steps focus style.
- 53f5f6e: Fix RTL styles for select and multiselect.
